    ...
    <div style={{ minHeight: "100vh", background: "#f5f0eb", fontFamily: "'Georgia', serif", padding: "2rem 1.5rem" }}>
      ...
      {user ? (
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.25rem", marginBottom: "1.25rem" }}>
            ...
            <div style={{
              ...
              <div style={{ position: "absolute", bottom: "-20px", right: "60px", width: "100px", height: "100px", borderRadius: "50%", background: "rgba(255,255,255,0.03)" }} />
            ...
            <div style={{ background: "#fdf8f4", borderRadius: "1.25rem", padding: "2rem", border: "1px solid #e8ddd4" }}>
              ...
              <div style={{ display: "flex", alignItems: "baseline", gap: "0.5rem", marginBottom: "0.35rem" }}>
                ...
                <span style={{ fontSize: "1.75rem", color: "#9ca3af", fontWeight: "400" }}>Days</span>
              </div>
              {streak > 0 && (
        ...
        <div style={{
          ...
          <h1 style={{ fontSize: "4rem", fontWeight: "700", color: "#1c1917", marginBottom: "1rem" }}>
            Welcome to Habitual
          </h1>
